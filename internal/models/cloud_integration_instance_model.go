...
func (m *CloudIntegrationInstanceModel) RefreshPropertyValues(diagnostics *diag.Diagnostics, response cloudIntegrationInstancesAPI.CloudIntegrationInstancesResponse, instanceId, cloudFormationLink *string) {
	if instanceId != nil {
